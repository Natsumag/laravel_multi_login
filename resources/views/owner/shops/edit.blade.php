                    ...
                    <form method="post" action="{{ route('owner.shops.update', ['shop' => $shop->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="-m-2">
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="name" class="leading-7 text-sm text-gray-600">ShopName</label>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative flex justify-around">
                                        <input type="radio" name="is_selling" id="is_selling" value="1" @if($shop->is_selling === 1){ checked } @endif>
                                        <label for="is_selling">Selling</label>
                                        <input type="radio" name="is_selling" id="not_selling" value="0" @if($shop->is_selling === 0){ checked } @endif>
                                        <label for="not_selling">Stopping</label>
                                    </div>
                                </div>
                                <div class="p-2 w-full flex justify-around mt-4">
                                    <button type="button" onclick="location.href='{{ route('owner.shops.index') }}'" class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Back</button>
